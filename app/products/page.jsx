	...
	return (
		<div className="cart container-xxl">
			<div className="cart-product">
				<h3 className="header">Products overview</h3>
				<div className="row">
						...
						<div className="col col-3 mb-4" key={index}>
							<div key={product.id} className="card h-100">
								...
								<div className="card-body">
									...
									{!cartProductIds.includes(product.id) &&	(<button className="btn btn-primary me-2" onClick={()=> dispatch(addToCart(product.id))}>
										<i className="bi bi-trash-fill" />Add Item
									</button>)}

									{cartProductIds.includes(product.id) && (<button className="btn btn-outline-danger" onClick={()=> dispatch(removeFromCart(product.id))}>
